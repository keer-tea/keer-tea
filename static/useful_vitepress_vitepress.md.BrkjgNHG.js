...
<span class="line"><span>export default config</span></span>
<span class="line"><span>\`\`\`</span></span>
<span class="line"><span>:::</span></span></code></pre></div><h2 id="包含-markdown-文件" tabindex="-1">包含 Markdown 文件 <a class="header-anchor" href="#包含-markdown-文件" aria-label="Permalink to &quot;包含 Markdown 文件&quot;">​</a></h2><p>你可以使用 <code>&lt;!--@include: ./xxx.md--&gt;</code> 语法使一个 markdown 文件中包含另一个 markdown 文件：</p><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;"># Docs</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;">## Basics</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">&lt;!--@include: ./parts/basics.md--&gt;</span></span></code></pre></div><h2 id="使用原封不动的静态资源" tabindex="-1">使用原封不动的静态资源 <a class="header-anchor" href="#使用原封不动的静态资源" aria-label="Permalink to &quot;使用原封不动的静态资源&quot;">​</a></h2><p>你可能需要使用原封不动的静态资源，比如这些文件 robot.txt，favicons，PWA icons。</p><p>你可以把这些文件放在源码目录的 public 目录下面。</p><p>比如，如果你的项目根目录是 ./docs 并且使用默认的资源目录位置，那么你的 public 目录将是 ./docs/public。</p><p>被放置到 public 的资源将会被复制到输出目录的根目录。</p><p>使用绝对根路径来引用放置在 public 目录里的文件。比如，在源代码中总是以 /icon.png 的形式来引入 public/icon.png 资源。</p><h2 id="基础-url" tabindex="-1">基础 URL <a class="header-anchor" href="#基础-url" aria-label="Permalink to &quot;基础 URL&quot;">​</a></h2><p>如果你的站点被部署到一个非根路由，你将需要在 .vitepress/config.js 中设置 base 选项。</p><p>比如，你计划部署你的站点到 <code>https://foo.github.io/bar/</code>，那么 base 应该设置为 &#39;/bar/&#39;（它的开头和结尾应该都是斜杠）。</p><p>所有你的静态资源路由将被自动处理以适应不同的 base 配置值。比如，你的 markdown 引用了在 public 目录下的资源，但是你不需要画蛇添足的加上 <code>/base/</code>。</p><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">![</span><span style="--shiki-light:#032F62;--shiki-light-text-decoration:underline;--shiki-dark:#DBEDFF;--shiki-dark-text-decoration:underline;">An image</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">](</span><span style="--shiki-light:#24292E;--shiki-light-text-decoration:underline;--shiki-dark:#E1E4E8;--shiki-dark-text-decoration:underline;">/image-inside-public.png</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p>但如果你要动态引入资源，可以使用 VitePress 提供的 withBase 辅助器。</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">script</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> setup</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">template</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span></code></pre></div>`,77),l=[e];function t(h,c,d,o,r,k){return n(),a("div",null,l)}const b=s(p,[["render",t]]);export{u as __pageData,b as default};
